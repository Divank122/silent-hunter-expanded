...
public class FreeSlyPower : CustomPowerModel
{
    ...
    {
        "zhs" => new PowerLoc("免费奇巧", "你的下一张奇巧牌耗能为0{energyPrefix:energyIcons(1)}。", "你的下{Amount}张奇巧牌耗能为0{energyPrefix:energyIcons(1)}。"),
        _ => new PowerLoc("Free Sly", "Your next Sly card costs 0 {energyPrefix:energyIcons(1)}.", "Your next {Amount} Sly cards cost 0 {energyPrefix:energyIcons(1)}.")
    };
